...
Module: NutUpsmonConf
 Parses /usr/local/ups/etc/upsmon.conf
...
About: Lens Usage
  Sample usage of this lens in augtool
    ...
    * Print all notification messages
      > print /files/usr/local/ups/etc/upsmon.conf/NOTIFYMSG

About: Configuration files
  This lens applies to /usr/local/ups/etc/upsmon.conf. See <filter>.
*)
...
let upsmon_filter = ( incl "/usr/local/ups/etc/upsmon.conf" )
			. Util.stdexcl
