(*
Module: NutNutConf
 Parses /usr/local/ups/etc/nut.conf
...
About: Lens Usage
  Sample usage of this lens in augtool
    ...
    * Print NUT MODE start-up configuration:
      > print /files/usr/local/ups/etc/nut.conf/MODE

About: Configuration files
  This lens applies to /usr/local/ups/etc/nut.conf. See <filter>.
*)
...
let nut_filter = ( incl "/usr/local/ups/etc/nut.conf" )
			. Util.stdexcl
