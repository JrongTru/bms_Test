(*
Module: NutUpsConf
 Parses /usr/local/ups/etc/ups.conf
...
About: Lens Usage
  Sample usage of this lens in augtool
    ...
    * Print all drivers used
      > print /files//usr/local/ups/etc/ups.conf/*/driver

About: Configuration files
  This lens applies to /usr/local/ups/etc/ups.conf. See <filter>.
*)
...
let ups_filter   = (incl "/usr/local/ups/etc/ups.conf")
                . Util.stdexcl
