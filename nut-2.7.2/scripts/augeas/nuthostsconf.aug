(*
Module: NutHostsConf
 Parses /usr/local/ups/etc/hosts.conf
...
About: Lens Usage
  Sample usage of this lens in augtool
    ...
    * Print all monitored upsd
	> print /files/usr/local/ups/etc/hosts.conf/MONITOR

About: Configuration files
  This lens applies to /usr/local/ups/etc/hosts.conf. See <filter>.
*)
...
let hosts_filter = ( incl "/usr/local/ups/etc/hosts.conf" )
                        . Util.stdexcl
